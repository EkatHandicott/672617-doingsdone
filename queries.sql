...
VALUES
("2019.01.11", "2019.12.01", 0, "Собеседование в IT компании", "interview.psd", "2019.10.02", 1, 3),
("2019.01.11", "2019.03.12", 0, "Выполнить тестовое задание", "task.psd", "2019.12.25", 1, 2),
("2019.01.12", "2019.04.12", 1, "Сделать задание первого раздела", "task2.psd", "2019.12.21", 2, 2),
("2019.01.15", "2019.08.12", 0, "Встреча с другом", "catchup.psd", "2019.12.22", 2, 1),
